<template>
  <div class="banner-config">
    <div class="mb10">
      <el-button type="success" size="small" @click="addOprate">添加Banner图</el-button>
    </div>
    ...
    <el-dialog
      ...
      <div class="tc-main">
        <div class="mb10">
          <span class="inline-block w100">Banner：</span>
          <div class="w300 inline-block">
            ...
            <el-upload
              ...
              multiple>
              <el-button class="vm" size="small" type="primary">点击上传Banner</el-button>
            </el-upload>
          </div>
        </div>
        <div class="mb10">
