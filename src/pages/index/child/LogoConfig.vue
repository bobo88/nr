<template>
  <div class="logo-config">
    <div class="mb10">
      <el-button v-if="logoConfigData && logoConfigData.length === 0" type="success" size="small" @click="addOprate">添加Logo图</el-button>
    </div>
    ...
    <el-dialog
      ...
      <div class="tc-main">
        <div class="mb10">
          <span class="inline-block w100">Logo：</span>
          <div class="w300 inline-block">
            ...
            <el-upload
              ...
              multiple>
              <el-button class="vm" size="small" type="primary">点击上传Logo</el-button>
            </el-upload>
          </div>
        </div>
        <div class="mb10">
    ...
    methods: {
      getLogo () {
        ...
        .then(data => {
          if (data.err === 0) {
            let _data = data.data;
            this.logoConfigData = _data.map((item) => {
              item.logo = this.Config.IMG_BASE_URL + item.logo;
              return item;
            });
            console.log('Logo data->', _data);
          } else {
