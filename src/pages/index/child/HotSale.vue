<template>
  <div class="hot-sale">
    <div class="mb10">
      <el-button type="success" size="small" @click="addOprate">添加热销车型图</el-button>
    </div>

    <el-table
      :data="hotSaleConfigData"
      border
      style="width: 100%">
      <el-table-column
        label="HotSale"
    ...
    <el-dialog
      ...
      <div class="tc-main">
        <div class="mb10">
          <span class="inline-block w100">HotSale：</span>
          <div class="w300 inline-block">
            ...
            <el-upload
              ...
              :action="actionHotSale()"
              :on-success="handleAvatarSuccess"
              multiple>
              <el-button class="vm" size="small" type="primary">点击上传HotSale</el-button>
            </el-upload>
          </div>
        </div>
        <div class="mb10">
    ...
    methods: {
      getHotSale () {
        ...
        .then(data => {
          if (data.err === 0) {
            let _data = data.data;
            this.hotSaleConfigData = _data.map((item) => {
              item.logo = this.Config.IMG_BASE_URL + item.logo;
              return item;
            });
            console.log('HotSale data->', _data);
          } else {
