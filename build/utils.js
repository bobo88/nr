...
exports.assetsPath = function (_path) {
  ...
  if (process.env.NODE_ENV === 'production_publish') {
    assetsSubDirectory = config.build_publish.assetsSubDirectory
  } else if (process.env.NODE_ENV === 'production_test') {
    assetsSubDirectory = config.build_test.assetsSubDirectory
  } else {
...
exports.cssLoaders = function (options) {
  ...
  var cssLoader = {
    loader: 'css-loader',
    options: {
      minimize: process.env.NODE_ENV === 'build_publish' || process.env.NODE_ENV === 'production_test',
